...
///les methodes
    ...
    public boolean inserir(Produit Produit) {
      String sql = "INSERT INTO produit(categorie_id,nom,libelle,prix,nombre_point,stocke,visib,image) VALUES(?,?,?,?,?,?,?,?)";
        try {
    ...
    String sql = "UPDATE produit SET id=?,categorie_id=?,nom=?,libelle=?,prix=?,nombre_point=?,stocke=?,visib=?,image=? WHERE id=?";
        try {
            PreparedStatement stmt = connection.prepareStatement(sql);
    ...
    public ArrayList<Produit> listar() {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Produit.setVisibilite(resultado.getInt("visib"));
    ...
    public ArrayList<Produit> list() {
       ...
       String sql = "select min(prix),id,categorie_id, nom,libelle,prix,nombre_point,stocke,visib,image from produit group by categorie_id";
    ...
    String sql = "UPDATE produit SET visib=? WHERE id=?";
        try {
            PreparedStatement stmt = connection.prepareStatement(sql);
