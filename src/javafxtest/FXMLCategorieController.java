...
public class FXMLCategorieController implements Initializable {
    ...
    @FXML
    private TableView<Categories> categorie;
    ...
    private ArrayList<Categories> listCategorie;
   
    private ObservableList<Categories>ObservablelistCategoriee;
   ...
   // private final ICategorie_parent ICategorie_parent =new ICategorie_parent();
    ...
    public void selecionarItemTableViewClientes(Categories Categorie){
    ...
    public void handleButtonAlterar() throws IOException {
        Categories Categorie = categorie.getSelectionModel().getSelectedItem();
        if (Categorie != null) {
            boolean buttonConfirmarClicked = showFXMLAjouterCategorieDialogController(Categorie);
            if (buttonConfirmarClicked) {
    ...
    public void handleButtonRemover() throws IOException, SQLException {
     ...
     public boolean showFXMLAjouterCategorieDialogController(Categories Categorie) throws IOException {
    ...
    private void handleretour(ActionEvent event) throws IOException {
        Parent p1 = FXMLLoader.load(getClass().getResource("AfterLogin.fxml"));
...
FilteredList<Categories>filetredData=new FilteredList<>(data,e->true);
    
    @FXML
    private void serachAmicale(ActionEvent event) {
             serachField.textProperty().addListener((observableValue,oldValue,newValue)->{
             filetredData.setPredicate((Predicate<? super Categories>)Categorie->{
            ...
            SortedList<Categories>sortedData=new SortedList<>(filetredData);
